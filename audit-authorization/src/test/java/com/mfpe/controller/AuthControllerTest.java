...
public class AuthControllerTest {
	...
	public void generateJwtTest() {
		...
		request.setUsername("satakshi");
		request.setPassword("sat000");
		// making projectManager
		projectManagerDetails = new ProjectManagerDetails(1, "Satakshi Aggarwal", "satakshi", "sat000", "Project-1");
	...
	public void validateJwt() {
		...
		authenticationResponse = new AuthenticationResponse("Satakshi Aggarwal", "Project-1", true);
		// first remove Bearer from Header
		String jwtToken = jwtTokenHeader.substring(7);
		String username = "satakshi";
